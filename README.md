...
Сверху событие, дата, город и площадка, ниже две-три карточки: дорога туда с номером поезда
или рейса, отель с ценой за всё проживание и временем пешком до площадки, дорога обратно,
итог одной цифрой и строка арифметики под ним, которая сходится. Дальше карта города с
...
| L3 | `src/composer/build-trip.ts`, `build-checkout.ts` | сборка поездки, бюджеты, живые ссылки на оплату |
